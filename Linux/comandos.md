...
- `df [opciones] ruta/directorio`
	- Significa *disk filesystem*. Muestra el espacio disponible y usado en el disco del ordenador. Al ejecutar el comando muestra una serie de columnas por defecto:
